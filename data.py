...
def main():
    percentilBuy97ETH, percentilSell97ETH = retreive_every_data_percentil('ETHM5')
    percentilBuy97BTC, percentilSell97BTC = retreive_every_data_percentil('BTCM5')
    ...
    if int(dataETH['createTime']) > int(lastDocETH['createTime']):
        ...
        update_data(
            {"createTime": dataETH['createTime']}, 'ETHM5',
            {
                "$set": {
    ...
    if int(dataBTC['createTime']) > int(lastDocBTC['createTime']):
        ...
        update_data(
            {"createTime": dataBTC['createTime']}, 'BTCM5',
            {
                "$set": {

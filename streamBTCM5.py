...
#{'_id': {'_data': '8264EA1A26000000072B022C0100296E5A10049B04AC2A66A24E1F96E1D68A5CE3BC6146645F6964006464EA1861130619E9D1A49A280004'}, 
#'operationType': 'update', 'clusterTime': Timestamp(1693063718, 7), 'wallTime': datetime.datetime(2023, 8, 26, 15, 28, 38, 398000), 
#'ns': {'db': 'CodeReaderLiquidations', 'coll': 'BTCM5'}, 'documentKey': {'_id': ObjectId('64ea1861130619e9d1a49a28')}, 
#'updateDescription': {'updatedFields': {'isBuyThreshold': False}, 'removedFields': [], 'truncatedArrays': []}}             
